...
func engineRouter() http.Handler {
	...
	r.Route("/situations", func(r chi.Router) {
		r.Get("/", handlers.GetSituations)
		r.Get("/{id}", handlers.GetSituation)
		r.Post("/validate", handlers.ValidateSituation)
		r.Post("/", handlers.PostSituation)
		r.Put("/{id}", handlers.PutSituation)
		r.Delete("/{id}", handlers.DeleteSituation)
		r.Get("/{id}/facts", handlers.GetSituationFacts)
		r.Get("/{id}/rules", handlers.GetSituationRules)
		r.Put("/{id}/rules", handlers.SetSituationRules)
		r.Get("/{id}/evaluation", handlers.GetSituationEvaluation)
		r.Get("/{id}/instances", handlers.GetSituationTemplateInstances)
		r.Post("/{id}/instances", handlers.PostSituationTemplateInstance)
		r.Put("/{id}/instances/{instanceid}", handlers.PutSituationTemplateInstance)
		r.Put("/{id}/instances", handlers.PutSituationTemplateInstances)
		r.Delete("/{id}/instances/{instanceid}", handlers.DeleteSituationTemplateInstance)
		r.Get("/{id}/instances/{instanceid}/calendars", handlers.GetSituationInstanceCalendars)
	})
