...
func adminRouter() http.Handler {
	...
	r.Get("/security/apikey", handlers.GetAPIKeys)
...
func engineRouter(services Services) http.Handler {
	...
	r.Post("/facts/execute", handlers.ExecuteFactOrGetHits)
	...
	r.Get("/variablesconfig/scope/{scope}", handlers.GetVariablesConfigByScope)
