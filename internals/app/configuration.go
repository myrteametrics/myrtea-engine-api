...
var AllowedConfigKey = []configuration.ConfigKey{
	...
	{Type: configuration.StringFlag, Name: "ENABLE_EXPLAINER_API", DefaultValue: "false", Description: "Enable explainer API"},
	{Type: configuration.StringFlag, Name: "EXPLAINER_API_SERVICE_URL", DefaultValue: "http://localhost:9005", Description: "Explainer API url"},
	{Type: configuration.StringFlag, Name: "EXPLAINER_API_DATASET_NAME", DefaultValue: "object", Description: "Explainer API dataset name"},
	{Type: configuration.StringSliceFlag, Name: "EXPLAINER_API_DATASET_FIELDS", DefaultValue: []string{"field1", "field2"}, Description: "Explainer API dataset fields"},
	{Type: configuration.StringFlag, Name: "EXPLAINER_API_ML_MODEL_NAME", DefaultValue: "randomforest", Description: "Explainer API machine learning model name"},
