...
func PostSituationTemplateInstance(w http.ResponseWriter, r *http.Request) {
	...
	instance, found, err := situation.R().GetTemplateInstance(instanceID, decodeUniqueKey)
	if err != nil {
...
func PutSituationTemplateInstances(w http.ResponseWriter, r *http.Request) {
	...
	oldInstances, err := situation.R().GetAllTemplateInstances(idSituation, decodeUniqueKey)
	if err != nil {
...
func GetSituationTemplateInstances(w http.ResponseWriter, r *http.Request) {
	...
	instances, err := situation.R().GetAllTemplateInstances(idSituation, decodeUniqueKey)
	if err != nil {
