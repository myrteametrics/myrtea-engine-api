...
func (service HistoryService) ExtractData(historySituations []HistorySituationsV4, historySituationFacts []HistorySituationFactsV4, historyFacts []HistoryFactsV4) search.QueryResult {
	...
	for _, historySituation := range historySituations {
		...
		situationRecord := search.SituationHistoryRecord{
			...
			Parameters:            historySituation.Parameters,
