...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmanagement.AuthenticationMode"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_myrteametrics_myrtea-engine-api_v5_internals_calendar.Calendar"
                            }
                        }
                    },
                    "500": {
        ...
        "/engine/history/facts/today/result": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "JSON payload containing criteria for fetching today's history fact result.",
                        "name": "ParamGetFactHistory",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "object"
        ...
        "/engine/issues/close": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Issues IDs",
                        "name": "issue",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.IssuesIdsToClose"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.IssuesIdsToDraf"
                        }
                    }
                ],
                "responses": {
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "items": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/search.SituationHistoryRecords"
                                }
                            }
                        }
                    },
        ...
        "/engine/variablesconfig": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "list of all Variables with it's config",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.VariablesConfig"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "VariableConfig definition (json)",
                        "name": "VariableConfig",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Ppost VariableConfig",
                        "schema": {
                            "$ref": "#/definitions/models.VariablesConfig"
                        }
                    },
        ...
        "/engine/variablesconfig/key/{key}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Variable Config key",
                        "name": "key",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": " One Variable Config getted by key",
                        "schema": {
                            "$ref": "#/definitions/models.VariablesConfig"
                        }
                    },
        ...
        "/engine/variablesconfig/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Variable Config ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "One Variable Config getted by id",
                        "schema": {
                            "$ref": "#/definitions/models.VariablesConfig"
                        }
                    },
        ...
        "/service/ingester": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/scheduler.ExternalAggregate"
                            }
                        }
                    }
                ],
                "responses": {
                    ...
                    "429": {
                        "description": "Processing queue is full please retry later"
                    },
                    "500": {
                        "description": "internal server error"
                    }
    ...
    "definitions": {
        "authmanagement.AuthenticationMode": {
            "type": "object",
            "properties": {
                "mode": {
                    "type": "string"
        ...
        "github_com_myrteametrics_myrtea-engine-api_v5_internals_calendar.Calendar": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
            ...
            "properties": {
                "aggs": {
                    ...
                    "additionalProperties": {
                        "$ref": "#/definitions/reader.ItemAgg"
                    }
                },
                "baselines": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/baseline.BaselineValue"
                    }
                },
                "buckets": {
                    "type": "object",
        ...
        "ruleeng.Case": {
            ...
            "properties": {
                "actions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ruleeng.ActionDef"
                    }
                },
                "condition": {
                    "type": "string"
                },
                "enableDependsForALLAction": {
                    "type": "boolean"
                },
                "enabled": {
                    "type": "boolean"
