...
func TestGetRootCauses(t *testing.T) {
	...
	var err error
	rootcause1 := model.NewRootCause(0, "rootcause1", "rootcause_desc_1", 1, 1)
	...
	rootcause2 := model.NewRootCause(0, "rootcause2", "rootcause_desc_2", 1, 1)
	...
	mapRootCauses := []model.RootCause{rootcause1, rootcause2}
